        ...
        resources: {
            en: {
                translation: {
                    ...
                    MembershipDec: {
                        text: 'Darul Ihsan Berlin is working in the path of Allah and managing a mosque. To further its mission, Darul' +
                    ...
                    MembershipRuleOne: {
                        text: 'All members must adhere to the Quran and Sunnah, remaining free from any acts of shirk, innovation' +
            ...
            de: {
                translation: {
                    ...
                    OurHistory: {text: 'Unsere Geschichte'},
            ...
            bn: {
                translation: {
                    ...
                    MembershipDec: {
                        text: 'দারুল ইহসান বার্লিন আল্লাহ্‌র দ্বীনের পথে কাজ করছে এবং একটা মসজিদ পরিচালনা করছে। দ্বীনের কাজকে এগিয়ে' +
                    ...
                    HomePageHeading:{
                      text: 'আল-আসরের (সময়ের) শপথ। নিশ্চয়ই মানুষ [গভীর] ক্ষতির মধ্যে রয়েছে, তবে তারা ব্যতীত যারা ঈমান আনে এবং সৎকর্ম করে, একে অপরকে সত্যের দিকে উৎসাহিত করে এবং একে অপরকে ধৈর্যের দিকে উৎসাহিত করে।'
                    },
                    HomePageHeadingSource:{
                      text:'আল-কুরআন ১০৩'
                    },
