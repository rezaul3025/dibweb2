...
export default function CashRegistration() {
    ...
    const startCashSaleHandler = () =>{
        if(typeof eventId !=='undefined' && cashSaleKey===process.env.REACT_APP_CASH_SALE_KEY){
            ...
            localStorage.setItem("cashSaleKey", cashSaleKey);
        }
    }

     useEffect(() => {
         const eventIdLs = localStorage.getItem("eventId");
        const cashSaleKeyLs = localStorage.getItem("cashSaleKey");
        setEventId(eventIdLs);
        setCashSaleKey(cashSaleKeyLs);
        setStartCashSale(eventIdLs && cashSaleKeyLs);
    }, []);
            ...
            <div className="container-fluid offer-section pb-5 py-5">
                <div className="container pb-5">
                    <div className="row g-4">
                        ...
                        <div className="modal fade" id="cashSaleModel" data-bs-backdrop="static"
                             data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel"
                             aria-hidden="true">
                            <div className="modal-dialog">
                                <div className="modal-content">
                                    <div className="modal-header">
                                        <h5 className="modal-title" id="cashSaleLoginModelTitle Label">Cash Sale Login</h5>
                                        <button type="button" className="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                    </div>
                                    <div className="modal-body">
                                        <div className="mb-3">
                                            <label htmlFor="eventId" className="form-label">Event
                                                Id</label>
                                        ...
                                        <div className="mb-3">
                                            <label htmlFor="cashSaleKey" className="form-label">Cash
                                                Sale Key</label>
