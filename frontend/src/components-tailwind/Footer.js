      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-1">
            <h3 className="text-green-500 text-xl font-bold mb-4">Darul Ihsan Berlin e.V.</h3>
          ...
          {/* Solutions */}
          <div>
            <h4 className="text-white text-sm font-semibold uppercase tracking-wider mb-4">Solutions</h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-white text-sm font-semibold uppercase tracking-wider mb-4">Subscribe to our newsletter</h4>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2023 Acme Inc. All rights reserved.</p>
