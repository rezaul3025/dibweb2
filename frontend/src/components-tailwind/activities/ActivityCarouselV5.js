...
const ActivityCarouselV5 = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      image: "/static/assets/img/event-default.png"
    },
    {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto overflow-hidden rounded-2xl shadow-lg bg-gray-50 border border-gray-100">
      {/* Carousel Container */}
      <div
        ...
        {events.map((event, index) => (
          <div key={index} className="w-full flex-shrink-0">
            <div className="flex flex-col lg:flex-row">
              ...
              {/* Responsive Thumbnail Image - Center on mobile, side on desktop */}
              <div className="lg:w-1/3 flex items-center justify-center p-4 lg:p-0 lg:pr-4 lg:pb-4 lg:pt-4">
                <div className="w-full h-64 md:h-72 lg:h-full rounded-lg lg:rounded-r-2xl overflow-hidden shadow-sm">
                  <img
                    src={event.image}
                    alt={event.title}
...
export default ActivityCarouselV5;